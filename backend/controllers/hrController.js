...
const deleteEmployeeEngagementController = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Employee engagement deleted successfully" });
  } catch (error) {
    res.status(400).json({ message: error.message });
  }
};
...
const deleteTimeAndAttendanceController = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Time and attendance record deleted successfully" });
  } catch (error) {
    res.status(400).json({ message: error.message });
  }
};
...
const updateEmployeeAssistantProgramController = async (req, res) => {
  try {
    const program = await updateEmployeeAssistantProgram(
      req.params.id,
      req.body
    );
    res.status(200).json(program);
...
const deleteEmployeeAssistantProgramController = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ message: "Employee assistant program deleted successfully" });
  } catch (error) {
    res.status(400).json({ message: error.message });
  }
};
